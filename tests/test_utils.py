...
def test_is_palindrome():
    ...
    assert is_palindrome("A man a plan a canal Panama") == False  # Case-sensitive check
    assert is_palindrome("A man a plan a canal Panama".replace(" ", "").lower()) == True  # Normalized check